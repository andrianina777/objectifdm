...
<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action="./controller/login.php" method="POST"  class="login100-form validate-form">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Entrer votre identifiant">
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Entrer votre mot de passe">
